...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo2.png" alt="ExpertSupport" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>ExpertSupport</b><br>Urb. Mariscal Cáceres, SJL: - Lima, Perú<br>Telefono:(+51)943278890<br>Email:brauns_1@hotmail.com
                </p>
            </div>
            <div id="fact">
